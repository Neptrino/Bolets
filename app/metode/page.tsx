          ...
          <div className="method-chapter-body">
            ...
            <div className="method-subscore-grid">
              <article className="method-subscore method-subscore-rain">
                ...
                <div className="method-rain-steps">
                  ...
                  <div>
                    ...
                    <Formula label="El balanç de pluja aplica un sòl mínim a la resposta saturant de pluja efectiva i dies humits. Cada pluja pesa segons la seva edat, amb una rampa per franges (0–7, 8–14, 15–21, 22–26 i 27–30 dies): entra i surt de la finestra gradualment en lloc de comptar de cop o desaparèixer d’un dia per l’altre. Per als gremis lents (micorízics i lignícoles) la setmana fresca pesa poc — els bolets d’avui es van desenvolupar abans — i el nucli de la finestra és la pluja de fa 8 a 21 dies. Per als ceps (Boletus) la rampa arriba més tard: dues temporades de dades de camp mostren que la seva florida triga unes dues setmanes, i el nucli és la pluja de fa 15 a 26 dies. Els sapròtrofs de prat i virosta responen en pocs dies i pesen sobretot la quinzena fresca.">
              ...
              <article className="method-subscore">
                ...
                <p>Exigim les 480 hores de model per a la finestra de 20 dies, també quan una espècie puntua només 14 dies. Si les estacions arriben amb retard, admetem fins a 12 hores finals sense observacions: en aquestes hores conservem la mitjana del model ajustada per altitud i els seus recomptes originals de calor i gelada. La resta de la finestra ha de tenir suport d’estacions; no omplim buits antics ni extrapolem observacions. Acceptem lectures publicades pendents de validació, però excloem dades invàlides, duplicats contradictoris i intervals incomplets. Si el retard supera 12 hores, hi ha altres buits de suport o el model no reprodueix la instantània original, conservem el càlcul anterior: mitjanes ajustades per altitud i hores d’extrems del punt d’AROME. La mitjana de 7 dies que intervé en l’aigua es manté sense aquest canvi.</p>
                ...
                <p>Aquesta versió considera tota la xarxa de temperatura de la XEMA i, per a cada cel·la, utilitza només les estacions properes amb dades vàlides i prou cobertura temporal. L’ampliació es va contrastar amb 170 estacions: va reduir l’error tèrmic mitjà i els salts entre cel·les comparables de punts meteorològics diferents, amb resultats de troballes molt similars però lleugerament inferiors. No garanteix cobertura a tot arreu ni converteix les cel·les de 250 m en mesures meteorològiques locals. Les lectures de 24 hores continuen mostrant el model; la combinació s’aplica a la mitjana llarga i als extrems que puntuen.</p>
              </article>
