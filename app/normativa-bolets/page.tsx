    ...
    <PageShell as="article">
      ...
      <aside className="panel-dark guide-answer" aria-labelledby="collecting-answer-title">
        ...
        <div>
          ...
          <h2 id="collecting-answer-title">No hi ha un carnet únic per collir bolets a tot Catalunya.</h2>
          <ul className="guide-answer-points">
            <li><strong>Gratuït</strong><span>En general, per a la recol·lecció particular</span></li>
            <li><strong>Tiquet</strong><span>En zones acotades, com Virós o Esterri de Cardós</span></li>
            <li><strong>Autorització</strong><span>Per a sortides organitzades en alguns espais protegits</span></li>
          </ul>
          <p>Els espais protegits, els ajuntaments i els propietaris poden establir limitacions. Confirma sempre la situació amb el gestor de l’espai.</p>
        </div>
      </aside>
      ...
      <section className="guide-section" aria-labelledby="collecting-permit">
        ...
        <Notice icon={ShieldAlert} title="Una guia de consulta, no una autorització." className="guide-caveat">Fonts consultades el <time dateTime="2026-08-27">27 d’agost de 2026</time>. Aquesta pàgina no substitueix la normativa aplicable ni els avisos vigents. Confirma sempre la situació amb el gestor de l’espai.</Notice>
      ...
      <section className="guide-section" aria-labelledby="collecting-cost">
        <SectionHeader title="Cal pagar per collir bolets?" titleId="collecting-cost" meta="Gratuïtat habitual, excepcions locals" />
        <p className="guide-prose"><strong>En general, la recol·lecció particular és gratuïta, però hi ha espais amb tiquet de pagament.</strong> És una orientació a partir de les fonts consultades, no una garantia per a qualsevol finca: els <a href={collectingSources.ruralAgents.url}>Agents Rurals expliquen les excepcions locals</a> i el <a href={collectingSources.altPirineuLeisure.url}>Parc Natural de l’Alt Pirineu descriu la gratuïtat habitual amb zones acotades de pagament</a>.</p>
        <p className="guide-prose">El <a href="#collecting-viros">Bosc de Virós</a> i la <a href="#collecting-esterri">vall d’Esterri de Cardós</a> són dos d’aquests casos. Hi trobaràs els imports publicats, els límits i la data de la font; no són tarifes ni quotes aplicables a tot Catalunya.</p>
        <p className="guide-prose">Que sigui gratuït no elimina les condicions de la propietat ni les restriccions d’accés. Igualment, pagar l’aparcament o una visita guiada no equival a obtenir un permís de recol·lecció.</p>
      </section>
      <section className="guide-section" aria-labelledby="collecting-local-rules">
        ...
        <div className="guide-factor-grid is-wide">
          <article>
            <Mountain size={22} />
            <span>Interior i perifèria diferents</span>
          ...
          <article>
            <Ticket size={22} />
            <span>Tiquet local publicat</span>
          ...
          <article>
            <Phone size={22} />
            <span>Contacta abans de sortir</span>
          ...
          <article>
            <CircleHelp size={22} />
            <span>Carnet actual no confirmat</span>
          ...
          <article>
            <Users size={22} />
            <span>Recol·lecció i grups</span>
            <h3>Els Ports</h3>
      ...
      <section className="guide-section" aria-labelledby="collecting-groups">
        ...
        <div className="guide-factor-grid is-wide">
          <article><ClipboardCheck size={22} /><span>Poblet</span><h3>Antelació mínima d’un mes</h3><p>El paratge demana autorització prèvia per a qualsevol activitat organitzada i presentar la sol·licitud al registre de la Generalitat almenys un mes abans. <a href={collectingSources.poblet.url}>Consulta el procediment indicat pel PNIN.</a></p></article>
        ...
        <Notice icon={ShieldAlert} title="Recol·lecció comercial." className="guide-caveat">Si la finalitat és comercial, no donis per fet que les condicions d’una sortida recreativa hi serveixen. Aquesta guia no cobreix els requisits de comercialització: concreta l’aprofitament amb el titular o gestor i consulta l’autoritat competent abans de vendre.</Notice>
      </section>
      <section className="guide-section" aria-labelledby="collecting-checks">
        <SectionHeader title="Quatre comprovacions abans de sortir" titleId="collecting-checks" meta="Permisos, accés i activitat" />
        <ol className="guide-step-flow is-four">
          <li><span aria-hidden="true">1</span><MapPin size={20} /><h3>Identifica el lloc</h3><p>Concreta el municipi, la finca i, si escau, el parc o paratge. Pregunta al gestor o a la propietat quines condicions afecten la recol·lecció al lloc escollit. No extrapolis una resposta d’un bosc a un altre.</p></li>
          <li><span aria-hidden="true">2</span><ClipboardCheck size={20} /><h3>Confirma què vols fer</h3><p>Explica si és una sortida particular, una activitat organitzada o una recol·lecció comercial. Si cal tiquet, comprova a qui autoritza, per a quina data i sector, i amb quin límit. No donis per vigent un carnet o una quota que aparegui en un article antic.</p></li>
          <li><span aria-hidden="true">3</span><Flame size={20} /><h3>Revisa el risc del dia</h3><p>Consulta el <a href={collectingSources.alfa.url}>mapa oficial del Pla Alfa</a> i els avisos del parc. El risc d’incendi pot comportar restriccions d’accés. El nostre mapa de bolets no mostra ni valida aquests permisos.</p></li>
          <li><span aria-hidden="true">4</span><Car size={20} /><h3>Comprova l’arribada</h3><p>Verifica les pistes obertes, la senyalització i l’aparcament autoritzat amb la informació local. Poder arribar a un bosc a peu no implica poder-hi circular amb vehicle o estacionar-hi en qualsevol punt. Una taxa d’aparcament o d’accés motoritzat no és un permís de recol·lecció.</p></li>
        </ol>
      </section>
      <section className="guide-section" aria-labelledby="collecting-equipment">
        ...
        <div className="guide-factor-grid">
          <article><ShoppingBasket size={22} /><span>Cistell</span><h3>Cistell rígid i airejat</h3><p>L’ACSA recomana un cistell, preferentment de vímet, que eviti aixafar els bolets. El recipient no fa segur un exemplar mal identificat i no justifica remoure la fullaraca.</p></article>
          <article><Compass size={22} /><span>Orientació</span><h3>Orientació i bateria</h3><p>Porta un mapa o una aplicació d’orientació, bateria suficient i una alternativa que no depengui de cobertura. Comparteix l’itinerari previst i fixa una hora de tornada.</p></article>
          <article><Shirt size={22} /><span>Roba</span><h3>Roba, aigua i visibilitat</h3><p>Adapta el calçat i la roba al terreny, porta aigua, menjar i una peça visible. No confiïs en una previsió de bolets com si fos una previsió meteorològica o d’accés.</p></article>
          <article><Ban size={22} /><span>Eines</span><h3>Ganivet, no rasclet</h3><p>Si portes una eina de tall, guarda-la amb seguretat. No utilitzis rasclets ni eines per remoure el sòl o la molsa: malmeten el bosc i no ajuden a identificar l’exemplar.</p></article>
        </div>
      </section>
