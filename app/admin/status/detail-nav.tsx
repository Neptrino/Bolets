...
export function DetailNav({ current }: { current: "status" | "users" | "findings" | "reports" | "contributions" | "instagram" }) {
  return (
    <nav className={styles.detailNav} aria-label="Seccions de l’administració">
      ...
      <Link href="/admin/status/contributions" aria-current={current === "contributions" ? "page" : undefined}>Aportacions</Link>
