  ...
  return (
    <PageShell as="article">
      ...
      <section className="seo-guide-section" id="privadesa">
        ...
        <p><strong>Aportacions i mapa detallat.</strong> Si proposeu una aportació, tractem el tipus, la descripció, l’enllaç d’evidència opcional, l’estat i la nota de revisió per valorar-la i administrar l’accés temporal al mapa d’1 km i 250 m. No hi ha pagaments, punts ni classificacions. Una aprovació afegeix 90 dies d’accés; una revocació conserva el motiu i l’auditoria necessaris per protegir el servei. La validació comunitària d’identificacions no forma part d’aquest sistema.</p>
