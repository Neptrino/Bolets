  ...
  return (
    <PageShell as="article">
      ...
      <section className="seo-guide-section" id="condicions">
        ...
        <p>Tot el contingut de {SITE_NAME} és educatiu i orientatiu. Cap fitxa, comparació, mapa o valoració de les condicions no constitueix una identificació micològica ni una garantia de comestibilitat. La identificació segura d’un bolet requereix la confirmació d’una persona experta amb l’exemplar al davant; no consumeixis mai cap bolet basant-te únicament en aquesta aplicació.</p>
        <p>El titular no es fa responsable dels danys derivats de decisions de recol·lecció o consum preses a partir del contingut del lloc, ni de la vigència de la normativa de recol·lecció de cada territori, que cal comprovar sempre amb la font oficial corresponent. Els mapes comparen condicions orientatives; no indiquen que hi hagi bolets.</p>
      ...
      <section className="seo-guide-section" id="privadesa">
        ...
        <p><strong>Aportacions i mapa detallat.</strong> Una troballa pública amb fotografia pot obrir temporalment el mapa d’1 km durant 7 dies, com a màxim una vegada cada 30 dies. Si proposeu una aportació, tractem el tipus, la descripció, l’enllaç d’evidència opcional, l’estat i la nota de revisió per valorar-la i administrar l’accés temporal al mapa d’1 km i 250 m. No hi ha pagaments, punts ni classificacions. Una aprovació afegeix 30 dies d’accés complet; una revocació conserva el motiu i l’auditoria necessaris per protegir el servei. La validació comunitària d’identificacions no forma part d’aquest sistema.</p>
        <p><strong>Troballes i ubicació.</strong> El formulari pot recollir l’espècie proposada, el moment, fotografies, quantitat, notes i coordenades. Abans de desar-les podeu triar entre conservar el punt exacte per al vostre mapa privat o descartar-lo i conservar només una zona pública aproximada de 10 × 10 km. El punt exacte, l’hora, la quantitat, les notes i les fotos privades no formen part de cap resposta pública. En públic es mostra el dia, l’espècie proposada, la zona aproximada i només les fotos i l’àlies que hàgiu autoritzat. La versió pública i generalitzada es pot utilitzar, de manera agregada, per avaluar, calibrar i millorar futures versions del model. El punt exacte, l’hora, les notes i les fotografies privades no s’utilitzen amb aquesta finalitat.</p>
        ...
        <p><strong>Mesura d’audiència.</strong> Fem servir una instal·lació pròpia d’Umami sense galetes, respectant «Do Not Track» i sense recollir la consulta ni el fragment de l’URL. En una mostra de sessions públiques també recollim la posició anònima dels clics i el percentatge de desplaçament per crear mapes de calor; no enregistrem la sessió, el text introduït ni el contingut de la pàgina. Mesurem el rendiment de les pàgines públiques i comptem de manera anònima quan comença un flux d’accés o el formulari d’una troballa, es crea un compte, es desa un esborrany local, una troballa acaba de sincronitzar-se, una infografia es prepara per baixar o es comparteix mitjançant el selector del sistema, comença o acaba el vídeo de la portada, s’obre el mapa des de la portada o una fitxa, se selecciona un sector, se’n canvia l’espècie o el mapa rep correctament la ubicació del dispositiu. Aquests esdeveniments no adjunten l’adreça electrònica, l’espècie seleccionada, el sector, les coordenades, cap dada de la troballa ni metadades de la infografia. Les pàgines d’accés, compte, quadern privat, moderació i captura de troballes continuen excloses de les visites, del rendiment i dels mapes de calor. No hi ha seguiment entre llocs ni perfils publicitaris.</p>
