...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="ca" className={nunitoSans.variable} data-scroll-behavior="smooth"><body><JsonLd data={{ "@context": "https://schema.org", "@graph": [{ "@type": "WebSite", "@id": `${SITE_URL}/#website`, url: SITE_URL, name: SITE_NAME, description: DEFAULT_DESCRIPTION, inLanguage: "ca" }, { "@type": "Organization", "@id": `${SITE_URL}/#organization`, name: SITE_NAME, url: SITE_URL, logo: `${SITE_URL}/icon.svg`, parentOrganization: { "@type": "Organization", name: "Neptrino Consulting SL" } }, { "@type": "Organization", "@id": `${SITE_URL}/#editorial-team`, name: editorialTeam.name, url: editorialTeam.url, parentOrganization: { "@id": `${SITE_URL}/#organization` } }, { "@type": "Person", "@id": siteAuthor.entityId, name: siteAuthor.name, url: siteAuthor.url, jobTitle: siteAuthor.role, description: siteAuthor.summary, worksFor: { "@id": `${SITE_URL}/#organization` } }] }} /><SiteHeader /><main>{children}</main><SiteFooter /><RegisterServiceWorker />{umamiWebsiteId ? <Script src="https://analytics.bolets.app/script.js" data-website-id={umamiWebsiteId} data-domains="bolets.app,www.bolets.app" data-do-not-track="true" data-exclude-search="true" data-exclude-hash="true" data-exclude="/admin/status" strategy="afterInteractive" /> : null}</body></html>;
}
