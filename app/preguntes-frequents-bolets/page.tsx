...
const topics: HuntingTopic[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: <>Sí: la pluja no és l’única condició que compta. La calor i el vent sec poden afavorir la pèrdua d’aigua i deixar unes condicions desfavorables malgrat la pluja recent. Llegiu <Link href="/quan-surten-els-bolets-despres-de-ploure">què canvia al bosc després de ploure</Link> i contrasteu-ho amb les <Link href="/bolets-avui">condicions actuals per territori</Link>; no hi ha un llindar universal per a tots els bolets.</>,
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer: <>Depèn del bosc: no hi ha un carnet únic que autoritzi a collir a tot Catalunya. Hi ha restriccions locals i espais amb tiquet, mentre que en d’altres la recol·lecció particular és gratuïta. Reviseu la <Link href="/normativa-bolets">guia de permisos per collir bolets</Link> i l’apartat de <Link href="/normativa-bolets#collecting-cost">cost i excepcions</Link>. Confirmeu les condicions vigents amb el gestor; pagar l’aparcament no equival a tenir permís de recol·lecció.</>,
        sources: [collectingSources.ruralAgents, collectingSources.altPirineuLeisure],
      },
      {
        id: "quantitat",
        question: "Quants quilos de bolets puc collir?",
        answer: <>No extrapoleu el límit d’un bosc a tot Catalunya. Comproveu si la finca o l’espai fixa una quota, a qui s’aplica i per a quina data i activitat. A les <Link href="/normativa-bolets#collecting-local-rules">regles de recol·lecció per espai</Link> diferenciem exemples locals i dates de les fonts; una quantitat publicada en un any anterior no confirma el límit vigent.</>,
        sources: [collectingSources.ruralAgents],
      },
      {
        id: "tallar-o-arrencar",
        question: "És millor tallar o arrencar els bolets?",
        answer: <>No ho convertiu en una regla universal. Un estudi de llarg termini en boscos suïssos no va detectar una reducció de les collites futures ni en tallar ni en arrencar; en canvi, el trepig va reduir el nombre de bolets. Això no justifica collir sense límits ni remoure el sòl. Respecteu les normes del lloc i les <Link href="/normativa-bolets#collecting-care">bones pràctiques de recol·lecció</Link>; el resultat de l’estudi no es pot extrapolar a qualsevol bosc o manera de collir.</>,
      ...
      },
      {
        ...
        answer: <>L’ACSA recomana un cistell rígid i airejat, preferentment de vímet, per evitar que els bolets es deteriorin durant la collita. El recipient no fa segur un bolet mal identificat. Recolliu només els que coneixeu bé i consulteu també com <Link href="/normativa-bolets#collecting-care">respectar el bosc quan colliu bolets</Link>.</>,
        sources: [officialSafetySource],
      },
      {
        id: "amb-nens",
        question: "Com preparar una sortida a buscar bolets amb nens?",
        answer: <>Trieu un recorregut conegut i adequat a l’edat i la condició física del grup. Consulteu el temps, porteu aigua, menjar, roba visible i mitjans d’orientació, manteniu el contacte visual i planifiqueu el retorn abans que es faci fosc. Les <Link href="/zones">guies de zones</Link> expliquen el context del bosc, però no certifiquen itineraris aptes per a infants. Reviseu també les <Link href="/normativa-bolets">normes d’accés i recol·lecció</Link> abans de sortir.</>,
