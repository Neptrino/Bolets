...
export function FindingFlagButton({ findingId }: { findingId: string }) {
  ...
  return <div className="finding-stack">
    ...
    <dialog
      ref={dialog}
      className="site-dialog finding-report-dialog"
    ...
    >
      <form className="site-dialog-card" onSubmit={flag}>
        ...
        <div className="finding-field site-dialog-full"><span>Tipus de problema</span>
        ...
        <label className="finding-field site-dialog-full">Detalls opcionals
