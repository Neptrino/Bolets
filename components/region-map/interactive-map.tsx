...
import "@/app/styles/raster-map.css";
import type { RegionGeolocateControl, RegionMapAdapter, RegionMapMouseEvent } from "./map-adapter";
import { createProgressiveUpdate } from "@/components/region-map/progressive-update";
import { createRasterRegionMap as createRegionMap } from "./raster-map-instance";
...
export function RegionMap({
  ...
  const map = useRef<RegionMapAdapter | null>(null);
  ...
  useEffect(() => {
    ...
    const handleCellClick = (event: RegionMapMouseEvent) => {
    ...
    const updatePointer = (event: RegionMapMouseEvent) => {
