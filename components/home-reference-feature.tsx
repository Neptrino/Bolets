    ...
    <section className="home-reference page-width" aria-labelledby="home-reference-title">
      ...
      <div className="home-reference-body">
        ...
        <nav className="home-reference-topics" aria-label="Descobreix els bolets">
          <div><Languages size={23} aria-hidden="true" /><h3>Noms i confusions</h3><Link href="/noms-de-bolets-catala-castella">Noms catalans i castellans <ArrowUpRight size={14} aria-hidden="true" /></Link><Link href="/compare">Comparador d’espècies <ArrowUpRight size={14} aria-hidden="true" /></Link></div>
