export const UMAMI_EVENTS = {
  ...
  mapPriceSurveyShown: "map-price-v8-shown",
  mapPriceSurveyClicked: "map-price-v8-clicked",
  mapPriceSurveyBannerSnoozed: "map-price-v8-banner-snoozed",
  mapPriceSurveyPromptShown: "map-price-v8-prompt-shown",
  mapPriceSurveyPromptClicked: "map-price-v8-prompt-clicked",
  mapPriceSurveyPromptDismissed: "map-price-v8-prompt-dismissed",
  mapPriceSurveyOpened: "map-price-v8-opened",
  speciesMapOpen: "species-map-open",
  speciesLookalikeClick: "species-lookalike-click",
  speciesNavClick: "species-nav-click",
  speciesSectionIdentificacio: "species-section-identificacio",
  speciesSectionConfusions: "species-section-confusions",
  speciesSectionCuina: "species-section-cuina",
  speciesSectionEcologia: "species-section-ecologia",
  speciesSectionDistribucio: "species-section-distribucio",
  speciesSectionTargeta: "species-section-targeta",
  speciesSectionFonts: "species-section-fonts",
