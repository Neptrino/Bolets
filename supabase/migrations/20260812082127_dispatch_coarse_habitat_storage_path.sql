...
create or replace function public.read_weighted_legacy_coarse_potential_habitat_cells(
...
revoke all on function public.has_compact_habitat_coverage()
  from public, anon, authenticated;
grant execute on function public.has_compact_habitat_coverage()
  to service_role;

revoke all on function public.read_weighted_legacy_coarse_potential_habitat_cells(
  double precision, double precision, double precision, double precision,
  integer, text[], double precision, double precision, double precision, double precision, integer
) from public, anon, authenticated;
grant execute on function public.read_weighted_legacy_coarse_potential_habitat_cells(
  double precision, double precision, double precision, double precision,
  integer, text[], double precision, double precision, double precision, double precision, integer
) to service_role;

comment on function public.has_compact_habitat_coverage() is
  'Constant-time capability check backed by the partial compact-cover presence index.';
comment on function public.read_weighted_legacy_coarse_potential_habitat_cells(
  double precision, double precision, double precision, double precision,
  integer, text[], double precision, double precision, double precision, double precision, integer
) is 'Fast direct SQL reader for legacy dominant-cover rows; Edge dispatch switches away automatically when compact fractions exist.';
