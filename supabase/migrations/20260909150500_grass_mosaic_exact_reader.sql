-- Companion to 20260909150000_grass_mosaic_cover: the same grass-mosaic
-- bonus (matollar samples at 0.4 weight for grassland species with real
-- grass present) applied to the exact 250 m branch of the weighted reader.
