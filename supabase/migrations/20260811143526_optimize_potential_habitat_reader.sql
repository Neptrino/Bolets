...
) is 'Returns exact verified 250 m potential habitat at close zoom and 500 m evidence summaries for fast, coverage-weighted display at coarser zooms. Cells are model habitat units, never mushroom observations.';
