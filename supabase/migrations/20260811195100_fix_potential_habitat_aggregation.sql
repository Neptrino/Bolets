...
) is 'Returns exact verified 250 m potential-habitat matches and coverage-weighted coarse cells. Land cover, elevation, and soil gates must pass in the same 250 m cell; coarse coverage is the matching share of those base cells.';
