...
export const comparisonPages: ComparisonPage[] = [
  ...
  {
    slug: "rovello-vs-rovello-de-cabra",
    leftSpeciesId: "lactarius-sanguifluus",
    rightSpeciesId: "lactarius-torminosus",
    title: "Rovelló vs. rovelló de cabra: diferències clau",
    shortTitle: "Rovelló vs. rovelló de cabra",
    metaDescription: "Diferències entre el rovelló i el rovelló de cabra tòxic: làtex, marge del barret, arbre associat i risc de confusió.",
    searchTerms: ["rovelló de cabra", "rovello vs rovello de cabra", "rovelló fals pelut"],
    introduction: "El nom rovelló fa pensar en dos bolets propers, però aquesta parella difereix en trets visibles i en seguretat. Cal observar el làtex acabat de sortir, el marge del barret i l’arbre associat abans de considerar cap exemplar per al consum.",
    decisiveDifference: "El rovelló segrega làtex vermell vinós i té el marge llis; el rovelló de cabra segrega làtex blanc i mostra un marge densament pelut, sobretot quan és jove.",
    diagnosticTraits: [
      { label: "Color del làtex", left: "Vermell vinós des que surt de la carn o de les làmines.", right: "Blanc; no és taronja ni vermell quan apareix." },
      { label: "Marge del barret", left: "Llis, sense una franja llanosa.", right: "Cargolat i cobert de pèls densos, especialment en exemplars joves." },
      { label: "Barret", left: "Taronja apagat, vinós o verdós.", right: "Rosat o salmó, sovint amb cercles concèntrics més foscos." },
      { label: "Arbre associat", left: "Pins.", right: "Bedolls; la relació és un suport important, però no substitueix els trets del bolet." },
    ],
    fieldChecks: [
      "Mireu el marge amb llum lateral: una franja de pèls llanosos és el primer senyal del rovelló de cabra.",
      "Feu un tall net a una làmina i observeu el làtex sense tastar-lo: vermell vinós o blanc.",
      "Comproveu els arbres propers i busqueu bedolls, fins i tot si també hi ha pins al mateix bosc.",
      "Descarteu qualsevol exemplar que no concordi alhora en marge, làtex i arbre associat.",
    ],
    habitatAndSeason: "Les temporades se solapen a l’estiu tardà i la tardor. L’arbre separa millor que el mes: Lactarius sanguifluus és un bolet de pineda, mentre que Lactarius torminosus està íntimament lligat als bedolls. En un bosc mixt, cal identificar quin arbre acompanya realment cada grup.",
    confusionRisk: "El rovelló és un comestible apreciat; Aranzadi classifica el rovelló de cabra com a verinós i adverteix de trastorns intestinals greus. El nom compartit no redueix aquest risc.",
  },
  {
  ...
  },
  {
    ...
    title: "Moixernó vs. inocibe de Patouillard: confusió greu",
    shortTitle: "Moixernó vs. inocibe de Patouillard",
    metaDescription: "Compareu el moixernó comestible i l’inocibe de Patouillard molt tòxic: barret, làmines, enrogiment, olor i temporada.",
    introduction: "El moixernó i l’inocibe de Patouillard poden coincidir a la primavera i mostrar tons blancs o crema quan són joves. L’enrogiment pot aparèixer tard, per això cal revisar també la textura del barret i les làmines.",
    decisiveDifference: "El moixernó és carnós, amb làmines blanques molt denses i barret llis; l’inocibe té el barret fibril·lós, s’enrogeix progressivament i les làmines s’enfosqueixen.",
    diagnosticTraits: [
    ...
    fieldChecks: [
      "Oloreu primer: la farina fresca neta i intensa és la firma del moixernó.",
      ...
      "Comproveu les làmines: blanques i extraordinàriament denses (moixernó) contra grisenques i menys atapeïdes.",
    ],
    habitatAndSeason: "Tots dos fructifiquen a la primavera en prats, clarianes i vores de bosc: la coincidència plena de temporada i hàbitat és justament el que fa la parella perillosa. L’inocibe s’acosta més als planifolis; el moixernó, als prats oberts.",
