...
export const placeProfiles: PlaceProfile[] = [
  ...
  },
  {
    ...
    landscape: "La fageda, el fullarac i les obagues encaixen amb espècies que necessiten humitat sostinguda. Les activitats del parc han documentat una llarga tradició de descoberta de bolets en aquest entorn.",
  ...
  },
  {
    ...
    landscape: "Els boscos de fullarac profund i les obagues poden encaixar amb les trompetes de la mort quan la tardor manté una humitat alta i sense gelades persistents.",
...
export const speciesLocationPages: SpeciesLocationPage[] = [
  {
    ...
    seasonNote: "A la muntanya, el calendari pot començar abans a les cotes altes i avançar vall avall. El tram més favorable acostuma a concentrar-se entre final d’estiu i tardor, sempre després d’una rehidratació real del sòl.",
  },
  {
  ...
  },
  {
    ...
    seasonNote: "El potencial s’estén de final d’estiu a la tardor i sol culminar a l’octubre. La cota pot avançar la resposta, però les baixades brusques de temperatura i les gelades n’escurcen la finestra.",
  },
  {
  ...
  },
  {
    ...
    seasonNote: "El potencial principal va de final d’estiu a novembre, amb un pic general a l’octubre. A les cotes altes, el vent i les primeres gelades poden tancar la finestra encara que hagi plogut.",
  },
  {
  ...
  },
  {
    ...
    seasonNote: "El potencial se sol concentrar entre final d’estiu i tardor. A aquestes cotes, una nit freda pot afavorir el descens tèrmic necessari, però les gelades persistents tanquen la finestra.",
  },
  {
  ...
  },
  {
    ...
    habitatNote: "Les fagedes, els marges de bosc madur i els sòls amb bon drenatge encaixen especialment bé. El fullarac ha de conservar humitat sense quedar saturat i les obagues redueixen l’estrès de calor.",
  ...
  },
  {
    ...
    seasonNote: "El potencial va de final d’estiu a novembre i acostuma a culminar a l’octubre. Les pluges regulars i la frescor afavoreixen la resposta; el vent sec o una tardor càlida la poden frenar.",
  },
  {
  ...
  },
  {
    ...
    seasonNote: "La finestra general se situa entre final d’estiu i novembre, amb un pic habitual a l’octubre. La pluja repartida és més favorable que un xàfec, especialment si després bufa vent sec.",
  },
  {
    ...
    introduction: "Els boscos humits i el fullarac dels vessants de Viladrau poden coincidir amb l’ecologia de la trompeta de la mort. El seu color i la distribució irregular fan que sigui difícil de detectar.",
    habitatNote: "Les rouredes humides, fagedes pròximes i alzinars frescals amb fullarac profund són els ambients més compatibles. L’ombra i la retenció d’humitat pesen més que la simple etiqueta del bosc.",
  ...
  },
  {
    ...
    seasonNote: "El potencial principal se situa entre final d’estiu i tardor, amb un pic general a l’octubre. Cal pluja repartida que rehidrati el sòl; la calor, el vent sec o les gelades n’interrompen la resposta.",
  },
  {
    ...
    seasonNote: "La finestra general va de final d’estiu a novembre i sol culminar a l’octubre. Les pluges regulars i les temperatures fresques afavoreixen la resposta; el vent i una nova sequera la poden tallar.",
  },
  {
  ...
  },
  {
    ...
    seasonNote: "El potencial principal va de final d’estiu a octubre, habitualment amb màxim al setembre. Necessita pluja efectiva seguida de temperatures suaus; el vent sec o una baixada brusca n’aturen l’activitat.",
  },
  {
