...
const references = [
  ...
  { id: "gbif", title: "GBIF España — Cerca de registres", publisher: "GBIF España", url: "https://registros.gbif.es/occurrences/search", confidence: "moderate" as const },
...
speciesProfiles.push(
  profile({
    ...
    idealConditions: ["Fagedes, avetoses, rouredes i algunes pinedes", "Sòl humit, drenat i àcid a moderadament àcid", "10–19 °C després de pluges persistents", "Vent sec i calor excessiva: desfavorables"]
  }),
  profile({
    ...
    similarSpecies: [{ scientificName: "Boletus edulis", commonName: "Cep", mainDifferences: "Habitualment menys vinós i més associat a fagedes o avetoses.", edibility: "excellent_edible", toxicity: "Sense toxicitat coneguda." }, { scientificName: "Tylopilus felleus", commonName: "Mataparent", mainDifferences: "Porus rosats i gust amarg; no presenta el mateix reticle clar.", edibility: "inedible", toxicity: "No tòxic, però incomestible.", warning: true }],
  ...
  profile({
    ...
    seo: { title: "Cep negre o sureny: identificació i temporada", keywords: ["sureny", "sureny fosc", "siureny"] },
    identity: { commonName: "Cep negre", alternateNames: ["sureny", "siureny negre"], scientificName: "Boletus aereus", family: "Boletaceae", genus: "Boletus", edibility: "excellent_edible", identificationDifficulty: "Mitjana", typicalSize: "Barret de 7–20 cm", shortDescription: "Cep mediterrani de barret molt fosc, vinculat sobretot a alzinars i rouredes càlides." },
  ...
  profile({
    ...
    seo: {
      title: "Camagroc: identificació i on trobar camagrocs",
  ...
  profile({
    ...
    seo: {
      title: "Fredolic: identificació i fredolics tòxics",
  ...
  profile({
    ...
    seo: {
      title: "Llenega negra o llanega: com reconèixer-la",
  ...
  profile({
    ...
    seo: { title: "Camasec o carreretes: identificació i temporada", keywords: ["carreretes", "cama sec"] },
    identity: { commonName: "Camasec", alternateNames: ["cama-sec", "camassec", "carrereta", "carreretes"], scientificName: "Marasmius oreades", family: "Marasmiaceae", genus: "Marasmius", edibility: "edible", identificationDifficulty: "Alta", typicalSize: "Barret de 2–6 cm", shortDescription: "Petit bolet de prats amb peu tenaç i làmines espaiades, sovint disposat en rotllanes després de la pluja." },
