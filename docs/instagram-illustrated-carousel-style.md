...
The user approved the revised **La brossa torna amb tu** carousel on 7 September 2026. This is the visual reference for future manually created educational carousels. The frozen reference is in [`assets/style-references/illustrated-field-guide/approved-litter/`](../assets/style-references/illustrated-field-guide/approved-litter/). Use those images to judge the result, not just the description below.

![Approved litter carousel](../assets/style-references/illustrated-field-guide/approved-litter/contact-sheet.jpg)
