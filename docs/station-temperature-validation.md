...
Production definition: `xema-arome-blend-v1`, promoted from the tapered 50/50 candidate after the station, findings and boundary checks below. The user accepted the observed reduction of large artificial boundaries despite slightly lower findings discrimination. This is a temperature-source change; the ecology priors and unified water model are unchanged.
